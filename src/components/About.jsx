...
const About = () => {
  ...
  return (
    ...
    >
      ...
      <div className="">
        <div className="flex flex-col items-center p-5 text-gray-50">
          <h1 className="text-6xl font-title font-bold my-5 mb-10">About Us</h1>
          <h3 className="text-3xl font-another">Making a difference</h3>
        </div>
        <div className="text-gray-50 flex flex-col items-center">
          <p className="text-xl mx-10 py-4">
        ...
        <div className="flex flex-col p-10">
          <p className="text-3xl my-5 mb-10 flex flex-col items-center text-white">
            What we do:
          </p>
          <p className="text-xl text-gray-100 py-1">
            <span className=" text-2xl text-gray-500 font-bold pr-3">
              Workshops & Seminars:{" "}
            </span>
            Learn cutting-edge technologies and cybersecurity from experts.
          </p>
      ...
      <div className="py-5">
        <div className="flex justify-evenly py-5">
          <div className="w-64 h-40 border-2" style={{backgroundImage: `url(${img1})`, backgroundSize: "cover", backgroundRepeat: "no-repeat"}}></div>
          <div className=" w-64 h-40 border-2" style={{backgroundImage: `url(${img2})`, backgroundSize: "cover", backgroundRepeat: "no-repeat"}}></div>
        </div>
        <div className="flex justify-evenly my-5">
          <div className="w-64 h-40 border-2" style={{backgroundImage: `url(${img3})`, backgroundSize: "cover", backgroundRepeat: "no-repeat"}}></div>
          <div className="w-64 h-40 border-2" style={{backgroundImage: `url(${img4})`, backgroundSize: "cover", backgroundRepeat: "no-repeat"}}></div>
